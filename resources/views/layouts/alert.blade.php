<div id="alert">
    @if(Session::has('error'))
        <div class="absolute bg-red-200 px-5 py-3 right-2 rounded text-center text-smx top-26 z-10" id="redAlert">
    ...
    @if(Session::has('success'))
        <div class="absolute bg-green-200 px-5 py-3 right-2 rounded text-center text-smx top-26 z-10" id="greenAlert">
